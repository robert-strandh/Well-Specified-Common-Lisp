...
\newindex{xpackages}{pdx}{pnd}{Index of packages}
\newindex{xgeneral}{rdx}{rnd}{General index}
\newindex{xcode}{cdx}{cnd}{Index of character sequences}
\newindex{xkwd}{kdx}{knd}{Index of keword symbols}
\newindex{xtext}{tdx}{tnd}{Index of significant phrases}
\newindex{xgloss}{gdx}{gnd}{Glossary}
\setlength\sdim{2mm}
...
\inputtex{setup-cmfont.tex}
\inputtex{setup-tables.tex}
